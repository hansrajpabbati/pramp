public class BST_Successor_Search {
    ...
    static class BinarySearchTree {
        ...
        Node findInOrderSuccessor(Node inputNode) {
            ...
            while (inputNode.parent != null && inputNode.parent.right == inputNode) {
    ...
    public static void main(String[] args) {
        ...
        Node test = null, test1 = null, succ = null, succ1 = null;
        ...
        test1 = tree.getNodeByKey(11);


        // Find the in order successor of test
        succ = tree.findInOrderSuccessor(test);
        succ1 = tree.findInOrderSuccessor(test1);
